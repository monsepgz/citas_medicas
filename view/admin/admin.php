					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu messages-notif-box animated fadeIn" aria-labelledby="messageDropdown">
								...
								<li>
									<a class="see-all" href="javascript:void(0);">Mira todos los mensajes<i class="fa fa-angle-right"></i> </a>
								</li>
							</ul>
						</li>
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
								<li>
									<div class="dropdown-title">Usted tine 0 nuevas notificaciones</div>
								</li>
								<li>
								...
								<li>
									<a class="see-all" href="javascript:void(0);">Mostrar todas<i class="fa fa-angle-right"></i> </a>
								</li>
							</ul>
						</li>
...
$sql = "SELECT * FROM doctor   ORDER BY apedoc ASC LIMIT 2";
$query  =$con->query($sql);
$data =  array();
if($query){
    while($r = $query->fetch_object()){
